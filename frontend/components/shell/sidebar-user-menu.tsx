...
import { EditProfileDialog } from "@/components/shell/edit-profile-dialog";
...
export function SidebarUserMenu({
  ...
  return (
    <>
      ...
      {!profileHref && <EditProfileDialog user={user} open={editProfileOpen} onOpenChange={setEditProfileOpen} />}
    </>
  );
}
