    ...
    items: [
      {
        ...
        clientId: 4,
        type: 'paymentFailed',
        title: 'Αποτυχημένη πληρωμή από Έλενα Δημητρίου',
        detail: '€120',
        time: 'Πριν 2 ώρες',
        tone: 'red',
      },
      {
        ...
        clientId: 2,
        type: 'subscription',
        title: 'Μαρία Κωνσταντίνου',
        detail: 'Η συνδρομή λήγει σε 5 μέρες',
        time: 'Πριν 4 ώρες',
        tone: 'amber',
      },
      {
        ...
        detail: 'Η συνδρομή λήγει σε 6 μέρες',
        time: 'Πριν 4 ώρες',
        tone: 'amber',
      },
    ],
    ...
    items: [
      {
        ...
        type: 'paymentPaid',
        title: 'Νίκος Αλεξίου',
        detail: 'Η πληρωμή €150 επιβεβαιώθηκε',
        time: 'Χθες 14:30',
        tone: 'green',
      },
      {
        ...
        clientId: 7,
        type: 'updateMissing',
        title: 'Γιώργης Παπαδόπουλος',
        detail: 'Δεν έστειλε εβδομαδιαίο update',
        time: 'Χθες 09:00',
        tone: 'red',
      },
      {
        ...
        type: 'reward',
        title: 'Μαρία Κωνσταντίνου',
        detail: 'Έφτασε στόχο. Εκδόθηκε κουπόνι 20% WooCommerce',
        time: 'Χθες 08:15',
        tone: 'purple',
      },
      {
        ...
        clientId: 5,
        type: 'newClient',
        title: 'Νέος πελάτης εγγράφηκε',
        detail: 'Αλέξης Μιχαήλ',
        time: 'Χθες 07:40',
        tone: 'blue',
      },
    ],
    ...
    items: [
      {
        ...
        clientId: 6,
        type: 'message',
        title: 'Νέο μήνυμα από Δήμητρα Ιωάννου',
        detail: 'Χρειάζεται αλλαγή στο πρόγραμμα διατροφής',
        time: '03/06/2026 18:20',
        tone: 'blue',
      },
      {
        id: 9,
        clientId: 8,
        type: 'subscription',
        title: 'Πέτρος Λάμπρου',
        detail: 'Η συνδρομή έγινε ανενεργή',
        time: '02/06/2026 11:10',
        tone: 'slate',
      },
    ],
  },
